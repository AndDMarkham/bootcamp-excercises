class Snail {
    ...
    render() {
        ...
        const snail = this.element.querySelector('.snail__shell');
        snail.style.fill = `${this.color}`;

        document.addEventListener('keypress', () => {
            const racer = this.element.querySelector('.snail-racer');
            racer.style.animationDuration = `${this.speed}s`
            racer.style.animationPlayState = `running`;
        });
